...
namespace Robot::Common::Models
{
	...
	int CoinBalanceHelper::ObjectWrite(int index)//, MemoryMappedViewAccessor *dataAccessor, int coinId1, double value1, int coinId2, double value2)
	{
	...
	int CoinBalanceHelper::ObjectRead(int index)//, MemoryMappedViewAccessor *dataAccessor, int &coinId1, double &value1, int &coinId2, double &value2)
	{
