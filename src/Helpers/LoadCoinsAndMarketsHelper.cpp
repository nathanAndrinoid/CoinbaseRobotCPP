#include "LoadCoinsAndMarketsHelper.h"
...
namespace Robot::Common::Helpers
{
	...
	Coin *LoadCoinsAndMarketsHelper::LoadCoinAndMarketLists(MarketData *marketData, std::unordered_map<std::wstring, MarketPair*> &marketPairDict, std::vector<MarketPair*> &marketPairArray, std::unordered_map<int, Coin*> &coinDict, std::vector<Coin*> &coinArray)
	{
