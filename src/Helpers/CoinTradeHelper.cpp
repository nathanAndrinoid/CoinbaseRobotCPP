...
// {
//
// 	double CoinTradeHelper::TradeSingle()//MemoryMappedViewAccessor *accessor, int id, double toDollarValue, double balance, StringBuilder *sb, Coin *indexCoin, std::unordered_map<int, Coin*> &coinDict, std::vector<MarketRate*> &marketRates)
// 	{
...
// 	}
//
// 	void CoinTradeHelper::FindDollarValues(std::vector<Coin*> &coinArray, Coin *indexUSD, std::vector<MarketRate*> &marketRates, std::vector<double> &dollarBestValues, std::vector<std::vector<Coin*>> &dolarBestLinks, std::unordered_map<int, Coin*> &coinDict)
// 	{
...
// 	}
//
// 	void CoinTradeHelper::BuildBestPathToDollar0(Coin *cStart, Coin *cEnd, std::vector<MarketRate*> &marketRates, std::vector<double> &dollarBestValues, std::vector<std::vector<Coin*>> &dolarBestLinks)
// 	{
...
// 	}
//
// 	void CoinTradeHelper::BuildBestPathToDollar1(std::deque<MarketLevel*> &queue)
// 	{
// 		//foreach (MarketLevel ml in queue)
// 		//{
...
// 	}
//
// 	void CoinTradeHelper::SetBestPathStore(std::vector<PathStep*> &stepArray, Coin *lc, int startLength, int index)
// 	{
...
// 	}
//
// 	void CoinTradeHelper::SetSingleTradeFirst()//MemoryMappedViewAccessor *accessor, Coin *indexCoin, Coin *nextCoin, StringBuilder *sb, std::vector<MarketRate*> &marketRates)
// 	{
...
// 	}
//
// 	void CoinTradeHelper::ZeroOutCoins(std::unordered_map<int, Coin*> &coinDict)
// 	{
// 		// for (auto coin : coinDict)
// 		// {
// 		// 	coin->Value->pathStep->fromCoin = nullptr;
// 		// 	coin->Value->nativeValue0 = 0;
// 		// 	coin->Value->nativeValue1 = 0;
// 		// 	coin->Value->nativeValue2 = 0;
// 		// 	coin->Value->nativeValue3 = 0;
// 		// 	coin->Value->nativeValue4 = 0;
// 		// 	coin->Value->nativeValue5 = 0;
// 		// }
// 	}
//
// 	std::wstring CoinTradeHelper::CoinChain(Coin *lc)
// 	{
//
// 		// if (lc->pathStep->fromCoin == nullptr)
// 		// {
// 		// 	return nullptr;//lc->Symbol; // + " " + lc.dollarValue ;
// 		// }
//
// 		return nullptr;//CoinChain(lc->pathStep->fromCoin) + L" -> " + lc->Symbol + L" "; // + lc.dollarValue;
// 	}
//
// 	void CoinTradeHelper::GetIdList(Coin *cStart, std::vector<int> &eIds)
// 	{
// 		if (cStart == nullptr)
// 		{
// 		}
