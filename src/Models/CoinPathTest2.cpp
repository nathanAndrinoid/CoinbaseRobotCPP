...
namespace Robot::Common::Models
{
	...
	void CoinPathTest2::BuildBestPathToCoinMarket2(Coin *cEnd, double fee, std::vector<MarketRate*> &marketRates, std::unordered_map<int, PathStep*> &stepBestDict0, std::unordered_map<int, PathStep*> &stepBestDict1, std::unordered_map<int, PathStep*> &stepBestDict2)
	{
