...
namespace Robot::Common::Models
{
	...
	void CoinPathTest1::BuildBestPathToCoinMarket1()//Coin *cEnd, double fee, std::vector<MarketRate*> &marketRates, std::unordered_map<int, PathStep*> &stepBestDict0, std::unordered_map<int, PathStep*> &stepBestDict1)
	{
